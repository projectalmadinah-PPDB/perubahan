...
<body>
    <div class="my-10">
        <figure class="max-w-screen-md h-screen mx-auto text-center">
            ...
            <blockquote>
                <p class="text-2xl italic font-medium text-gray-900 dark:text-white">"Pembayaran Berhasil!!<br>Terimakasih."</p>
            </blockquote>
            <figcaption class="flex items-center justify-center mt-6 space-x-3">
                <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                    <a href="{{route('user.dashboard')}}" class="pl-3 text-sm text-gray-500 dark:text-gray-400">Kembali Ke Home</a>
