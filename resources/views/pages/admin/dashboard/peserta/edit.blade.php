                  ...
                  <div class="col-md-6">
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <input name="nomor" class="form-control @error('nomor') is-invalid @enderror" type="text" value="{{$data->nomor}}">
                          @error('nomor')
                            <div id="validationServerUsernameFeedback" class="invalid-feedback">
                              {{$message}}
                            </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('nisn') is-invalid @enderror"  name="nisn" placeholder="Enter Name" value="{{$data->student->nisn}}">
                          @error('nisn')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('nik') is-invalid @enderror"  name="nik" placeholder="Enter Name" value="{{$data->student->nik}}">
                          @error('nik')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('birthplace') is-invalid @enderror"  name="birthplace" placeholder="Enter Name" value="{{$data->student->birthplace}}">
                          @error('birthplace')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('hobby') is-invalid @enderror"  name="hobby" placeholder="Enter Name" value="{{$data->student->hobby}}">
                          @error('hobby')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('ambition') is-invalid @enderror"  name="ambition" placeholder="Enter Name" value="{{$data->student->ambition}}">
                          @error('ambition')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('last_graduate') is-invalid @enderror"  name="last_graduate" placeholder="Enter Name" value="{{$data->student->last_graduate}}">
                          @error('last_graduate')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('old_school') is-invalid @enderror"  name="old_school" placeholder="Enter Name" value="{{$data->student->old_school}}">
                          @error('old_school')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('organization_exp') is-invalid @enderror"  name="organization_exp" placeholder="Enter Name" value="{{$data->student->organization_exp}}">
                    ...
                    <div class="col-md-6">
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('father_name') is-invalid @enderror"  name="father_name" placeholder="Enter Name" value="{{$data->parents->father_name}}">
                          @error('father_name')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input name="father_phone" class="form-control @error('father_phone') is-invalid @enderror" type="text" value="{{$data->parents->father_phone}}">
                          @error('father_phone')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input name="mother_phone" class="form-control @error('mother_phone') is-invalid @enderror" type="text" value="{{$data->parents->mother_phone}}">
                          @error('mother_phone')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input name="mother_name" class="form-control @error('mother_name') is-invalid @enderror" type="text" value="{{$data->parents->mother_name}}">
                          @error('mother_name')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('father_job') is-invalid @enderror" name="father_job" value="{{$data->parents->father_job}}">
                          @error('father_job')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('mother_job') is-invalid @enderror" name="mother_job" value="{{$data->parents->mother_job}}">
                          @error('mother_job')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('child_no') is-invalid @enderror" name="child_no" value="{{$data->parents->child_no}}">
                          @error('child_no')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('no_of_sibling') is-invalid @enderror" name="no_of_sibling" value="{{$data->parents->no_of_sibling}}">
                          @error('no_of_sibling')
                          <div id="validationServerUsernameFeedback" class="invalid-feedback">
                            {{$message}}
                          </div>
